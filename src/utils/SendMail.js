...
const verifyUserTemplate = async (user_id) => {
    ...
    <html>
      <head>
        ...
        <title>Welcome To Certlify Email</title>
        <style>
          /* -------------------------------------
              GLOBAL RESETS
          ------------------------------------- */
                      ...
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            <h2>To start making use of our service, please use the token below to verify your email:</h2>
                                ...
                                <tr>
                                  <td align="left">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                      <tbody>
                                        <tr>
                                          <td style="padding: 10px;"> <b>${ otp.value }</b> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-block">
                        <span class="apple-link">powered by <a href="https://github.com/DSC-Unilag/certlify">DSC-Unilag</a></span>
...
exports.SendMail = async (to, type) => {
    ...
    switch (type) {
        case EMAIL_TYPES[0]:
            ...
            html = await verifyUserTemplate(to._id);
