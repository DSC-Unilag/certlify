...
function Login({ hideLoader }){
    ...
    return(
            ...
            <form id="email-input" className="form-input" >
                ...
                <button id="submit" type="submit"  className="sign-log">
                    Login
                </button>
            </form>
            <p id="email-verification" className="message" style={{display:"none"}}></p>
            <button id="verify"type="button" className="sign-log" style={{display:"none"}}>
                Verify
            </button>
